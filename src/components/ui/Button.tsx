...
type Variant = "primary" | "secondary" | "outline" | "ghost" | "danger" | "success" | "navy";
...
const VARIANTS: Record<Variant, string> = {
  primary:   "bg-orange-600 text-white hover:bg-orange-700 focus:ring-orange-500 shadow-sm shadow-orange-200",
  navy:      "bg-[#0a2342] text-white hover:bg-[#0a2342]/90 focus:ring-[#0a2342] shadow-sm",
  secondary: "bg-slate-100 text-slate-900 hover:bg-slate-200 focus:ring-slate-400",
  outline:   "border border-slate-200 bg-transparent text-slate-700 hover:bg-slate-50 focus:ring-slate-300",
