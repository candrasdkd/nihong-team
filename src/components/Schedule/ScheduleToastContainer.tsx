...
import { ToastMsg } from "../../hooks/useSchedules";

interface ScheduleToastContainerProps {
  toasts: ToastMsg[];
  remove: (id: number) => void;
}

export function ScheduleToastContainer({ toasts, remove }: ScheduleToastContainerProps) {
  return (
